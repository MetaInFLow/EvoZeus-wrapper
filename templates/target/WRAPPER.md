...
- Local Skill project mirror: `~/.evozeus/.projects/{{REPO_NAME}}/SKILL.md`
...
1. Bootstrap preserves the original local Skill project entry in `~/.evozeus/.projects/{{REPO_NAME}}/SKILL.md`.
